...
<MinecraftWindow
  type="chest" rows={2} title="Product catalog"
  layout={['AB#######', '########D']}
  items={{
    A: {icon: 'apple', name: 'Apple'},
    B: {icon: 'bread', name: 'Bread'},
    D: {icon: 'diamond', name: 'List a diamond'},
  }}
/>
...
<NextStep
  ...
  description="Keep page content, arrows, and page numbers in step with the data."
/>
