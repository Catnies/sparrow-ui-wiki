---
title: Sending and injecting
sidebar_label: Sending and injecting
---
...
<NextStep
  ...
  title="Object lifecycle and subscriptions (optional)"
  description="How objects, observers, and subscriptions are released when work ends."
/>
