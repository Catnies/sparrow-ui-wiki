...
窗口标题可以使用固定文本，也可以从业务数据生成。菜单打开后，仍可通过 Window 更新标题。

## 更新标题

Builder 的 `setTitle` 设置初始标题。菜单打开后，调用 Window 的同名方法即可请求更新，无需重新创建 Window 或 Pane。
...
<NextStep
  to="/window/data"
  title="窗口数据"
  description="给窗口附带业务对象，处理客户端状态确认和容器外点击。"
/>
